...
Risk assessments, in theory, account for the concept of resilience by combining exposure, resilience, and adaptive capacity indicators (see left panel of the figure below). In practice however, resilience literature is not connected to the one of risk assessment, and resilience indicators are not used neither when evaluating the vulnerability of ecosystem areas (right panel of the figure).

In a manuscript, we highlight this disconnect using a bibliography analysis, and using a global dryland dataset, show how to combine resilience indicators with exposure to pinpoint the most vulnerable dryland areas.

## ![](Figures/risk.jpg)

[A framework for integrating resilience indicators into risk
assessments](https://ecoevorxiv.org/repository/view/12909/). (2026) B. Pichon, S. Kéfi, I. Gounand, S. Donnet (**in press**) *Conservation Biology*
...
In manuscripts in preparation, we investigated how dominance and dispersion of plant traits were associated with drought resistance and recovery time after droughts along a large aridity gradient. We also investigated how the different facets of diversity (taxonomic, functional, phylogeny) drive this different dimensions of stability.

## ![](Figures/trait_time.jpg)

## Resilience in space

Dryland ecosystems, alongside others such as salt-marshes and mussel-beds, exhibit characteristic two-phase spatial mosaics with vegetation aggregated in patches and separated by open areas. We are interested in developping methods to link plant spatial patterns and resilience, as well as understanding how such spatial structure changes along stress gradients (**i.e.,** grazing or aridity).

#### Climatic legacies drive spatial aggregation of plants in drylands

In this work, we focused on the contribution of current and past climates in explaining present-day spatial vegetation patterns. So we were asking whether there was climate legacies on present-day spatial vegetation patterns. We show that past climates from the mid-Holocene and Last Glacial Maximum have effects of similar magnitude as current climate on the vegetation cover, but have remarkably stronger imprint on the spatial aggregation of vegetation in drylands. Furthermore, we found that climate legacies on plant spatial patterns might relate to climate long-lasting effects on soil multifunctionality and sand content. This study emphasizes the different timescales of processes involved in vegetation patterning in drylands, which we should account for when assessing dryland functioning and resilience from these patterns.

[Climatic legacies drive spatial aggregation of plants in drylands](https://onlinelibrary.wiley.com/doi/10.1111/gcb.70907). (2026) B. Pichon, S. Kéfi, I. Gounand, S. Donnet *Global Change Biology*

![](Figures/legacy.jpg)

#### Vegetation patterns pinpoint the least resilient dryland sites

We developped an inverse-modelling approach relying on Approximate Bayesian Computing, which uses a snapshot of the spatial structure of ecosystems characterized by so-called irregular patterns, and estimate a distance to its desertification point regardless of whether it is reached via progressive or sudden degradation (first figure below). The approach allows to comparably rank sites according to their resilience, which is here estimated as each site’s distance to its desertification point. We validated the approach on simulated landscapes from different models, showing that the approach performs well at ranking all landscapes. We applied the approach to a global dryland dataset (see for instance for the three sites in the second figure below). We believe this approach can be used in risk assessments where resilience is most often omitted !!
