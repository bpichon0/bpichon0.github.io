...
I'm interested in understanding how the diversity of habitats, the type of spatial flows (dispersal, inorganic resources subsidies), and their characteristics (quantity and stoichiometry) affect the "functioning" of ecosystems and whole landscape. This is made possible by the development of models and the analyses of data gather in global syntheses.
...
In this first work, we reviewed spatial feedbacks that emerge from the flows of resources and organisms across populations, communities, and ecosystems in space.
...
![](Figures/meta_eco_feedback.jpg){width="493"}
...
![](Figures/meta_eco_redfield.jpg){width="494"}
